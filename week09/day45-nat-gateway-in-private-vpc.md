...
~ on ☁️  (us-east-1) ➜  aws ec2 describe-route-tables   --filters "Name=vpc-id,Values=$vpc_id"
{
    "RouteTables": [
        {
            "Associations": [
                {
                    "Main": true,
                    "RouteTableAssociationId": "rtbassoc-0401e14060c5ce633",
                    "RouteTableId": "rtb-04edce901cef54880",
                    "AssociationState": {
                        "State": "associated"
                    }
                },
                {
                    "Main": false,
                    "RouteTableAssociationId": "rtbassoc-06c7dec73b124d92c",
                    "RouteTableId": "rtb-04edce901cef54880",
                    "SubnetId": "subnet-0ccb66bb9298af497",
                    "AssociationState": {
                        "State": "associated"
                    }
                }
            ...
            "Routes": [
                ...
                },
                {
                    ...
                    "NatGatewayId": "nat-01ace4f5df6b8615c",
                    "Origin": "CreateRoute",
                    "State": "active"
                }
            ],
            "Tags": [],
            "VpcId": "vpc-04f912bdcbe607adb",
            "OwnerId": "359361141032"
        },
        {
            "Associations": [
                {
                    "Main": false,
                    "RouteTableAssociationId": "rtbassoc-0ff84c3e04f754136",
                    "RouteTableId": "rtb-0f73110ca73eb10ce",
                    "SubnetId": "subnet-0aa7bf343f8cc2c17",
                    "AssociationState": {
                        "State": "associated"
                    }
                }
            ...
            "Routes": [
                ...
                {
                    "DestinationCidrBlock": "0.0.0.0/0",
                    "GatewayId": "igw-0fad7ee1b041c6c19",
                    "Origin": "CreateRoute",
                    "State": "active"
                }
            ],
...
~ on ☁️  (us-east-1) ➜  aws ec2 describe-route-tables   --filters "Name=vpc-id,Values=$vpc_id" --query "RouteTables[?^C

~ on ☁️  (us-east-1) ✖ public_rt_id=$(aws ec2 describe-route-tables \
  --filters "Name=tag:Name,Values=$public_route_table_name" \
  --query "RouteTables[0].RouteTableId" \
  --output text 2>/dev/null) && echo "Public Route Table ID: $public_rt_id"
Public Route Table ID: None
